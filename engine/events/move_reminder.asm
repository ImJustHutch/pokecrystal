...
.loop
	...
	push bc
	ld c, a
	ld b, 0							;allows moved from pre-evolutions
...
.done
	callba GetPreEvolution			;allows moved from pre-evolutions
	pop bc
	jr c, .loop						;allows moved from pre-evolutions
	pop af
	ld [wCurPartySpecies], a
	ld a, b
	ld [wd002], a
